# -*- coding: utf-8 -*-
"""Aula1_Comandos_Básicos.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1BURVNpN-PkF-VZKtJFHQpHOqvJHcIYN0
...
print(f"O dobro de {numreal} é {dobro} e a terça parte é {terca}")
...
print(f"A área da parede é: {area}m² \nA quantidade de tinta necessário são: {tinta}L")
...
print(f"O preço do produto com desconto de 10% é: {precof}")
...
print(f"Seu novo salário é: {newsalario}")
...
print(f"O tempo da viagem é: {tempo}h")
...
print(f"O valor da conta de energia é: {conta}")
...
kmrodado = float(input("Digite a quantidade de Km percorrido: "))
dias = float(input("Digite a quantidade de dias pelos quais ele foi alugado: "))
preco1 = kmrodado * 0.20
preco2 = dias * 90
precofinal = preco1 + preco2

print(f"O valor a ser pago pelo aluguel do veículo é de R${precofinal}")

#exercicio 18

preco = float(input("Digite o custo de fábrica do carro: "))
distribuidor = preco * 0.28
impostos = preco * 0.45
precofinal = preco + distribuidor + impostos

print(f"O preço final do carro é: {precofinal}")